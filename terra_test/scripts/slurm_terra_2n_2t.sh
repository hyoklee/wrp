#!/bin/bash
#SBATCH --job-name=terra_2n_2t
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=2
#SBATCH --time=04:00:00
#SBATCH --output=/mnt/common/hyoklee/core.iowarp/terra_test/logs/terra_2n_2t_%j.out
#SBATCH --error=/mnt/common/hyoklee/core.iowarp/terra_test/logs/terra_2n_2t_%j.err
#SBATCH --exclusive
