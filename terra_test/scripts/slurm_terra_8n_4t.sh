#!/bin/bash
#SBATCH --job-name=terra_8n_4t
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=4
#SBATCH --time=04:00:00
#SBATCH --output=/mnt/common/hyoklee/core.iowarp/terra_test/logs/terra_8n_4t_%j.out
#SBATCH --error=/mnt/common/hyoklee/core.iowarp/terra_test/logs/terra_8n_4t_%j.err
#SBATCH --exclusive
